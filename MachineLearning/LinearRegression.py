...
def data():
    ...
    data = pd.read_csv('c:\\Users\\angix\\Downloads\\Modulo3\\Diamonds_Prices2022.csv')            
    return data
...
#from collections import defaultdict #https://bobbyhadz.com/blog/python-keyerror-0
#x = defaultdict(list)
#print(x)
